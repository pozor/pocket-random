...
Need help with Randomix? You're in the right place!
...
### In-App Help
Every tab in Randomix has a **Help button (?)** in the top-right corner with context-specific instructions.
...
- Randomix version (visible in Settings tab)
...
Steps to reproduce:
1. Open Number Generator
2. Set min=100, max=10 (invalid)
3. Tap "Generate"
...
- Account or billing questions (future paid features)
- Press or partnership inquiries

**Not ideal for:**
- General questions (use GitHub Issues for faster community help)
- Feature requests (GitHub allows voting/discussion)

---

## 🌍 Language Support

Randomix is available in 6 languages:
- 🇬🇧 English
- 🇮🇹 Italian (Italiano)
- 🇫🇷 French (Français)
- 🇩🇪 German (Deutsch)
...
**Recommended:**
- iOS 16.0 or later (for best accessibility features)
- iPhone 8 or newer

**Not compatible:**
- Apple Watch (no watchOS version)
- Apple TV
- macOS (no Catalyst support yet)
...
3. Check available storage (need 50+ MB)
4. Sign out/in to App Store
5. If still failing, delete and reinstall (⚠️ **Warning:** This deletes your phrase lists and history)
...
### Number Generator
- **Tip:** Turn off "Allow repetitions" to exhaust all numbers in a range
- **Tip:** Use History sorting to find min/max generated values
- **Tip:** Previous number display helps avoid accidental re-rolls

### Phrase Generator
- **Tip:** Assign weight=10 to frequently wanted items, weight=1 to rare items
- **Tip:** Probability = weight / total_weights (e.g., 5/(5+2+3) = 50%)
- **Tip:** Swipe to delete phrases quickly

### Distributions *(Coming Soon)*
- **Tip:** Normal distribution: μ=center, σ=spread (68% within ±1σ)
- **Tip:** Use Poisson for counting events (customers per hour, etc.)
- **Tip:** Generate 20+ numbers to see theory vs practice chart
...
- Feature requests: 1-7 days (may take longer to implement)
- Questions: 1-2 days
...
**Not getting responses?** Check your spam folder or verify GitHub notifications are enabled.
